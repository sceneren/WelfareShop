...
public class Config {
    ...
    public final static String FONTTYPE_QIHEI = "";
    public final static String FONTTYPE_WAWA = "";

    public final static String FONTTYPE_FZXINGHEI = "";
    public final static String FONTTYPE_FZKATONG = "";
    public final static String FONTTYPE_BYSONG = "";
