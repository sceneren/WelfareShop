...
public class UserInfo extends BaseBean {
    ...
    private int deduct;
    private int create_hour;
    private int create_date;
    private int welfare_unlock;
    private int secret_unlock;
    private int score;
    ...
    public void setCreate_hour(int create_hour) {
    ...
    public int getWelfare_unlock() {
        return welfare_unlock;
    }

    public void setWelfare_unlock(int welfare_unlock) {
        this.welfare_unlock = welfare_unlock;
    }

    public int getSecret_unlock() {
        return secret_unlock;
    }

    public void setSecret_unlock(int secret_unlock) {
        this.secret_unlock = secret_unlock;
    }
