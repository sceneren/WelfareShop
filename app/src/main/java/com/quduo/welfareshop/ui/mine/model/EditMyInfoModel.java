...
public class EditMyInfoModel {
    ...
    public void updateMyInfo(HttpParams params, final HttpResultListener<Boolean> listener) {
        OkGo.<LzyResponse<Boolean>>post(ApiUtil.API_PRE + ApiUtil.UPDATE_MY_INFO)
                .tag(ApiUtil.UPDATE_MY_INFO_TAG)
                .params(params)
                .execute(new JsonCallback<LzyResponse<Boolean>>() {
                    @Override
                    public void onSuccess(Response<LzyResponse<Boolean>> response) {
