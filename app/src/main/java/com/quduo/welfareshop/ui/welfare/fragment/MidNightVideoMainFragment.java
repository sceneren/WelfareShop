 ...
 * Description:午夜影院
 */
public class MidNightVideoMainFragment extends BaseMainMvpFragment<IMidNightVideoView, MidNightVideoPresenter> implements IMidNightVideoView {
    ...
    public static MidNightVideoMainFragment newInstance() {
        Bundle args = new Bundle();
        MidNightVideoMainFragment fragment = new MidNightVideoMainFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_welfare_midnight_video_main, container, false);
