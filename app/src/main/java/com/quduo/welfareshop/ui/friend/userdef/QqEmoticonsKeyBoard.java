...
public class QqEmoticonsKeyBoard extends AutoHeightLayout implements EmoticonsFuncView.OnEmoticonsPageViewListener,
    ...
    public void onFuncChange(int key) {
        ...
        switch (key) {
            case FUNC_TYPE_PTT:
                btnVoice.setImageResource(R.drawable.qq_skin_aio_panel_ptt_press);
                break;
            case FUNC_TYPE_PTV:
                btnPtv.setImageResource(R.drawable.qq_skin_aio_panel_ptv_press);
                break;
            case FUNC_TYPE_IMAGE:
                btnImage.setImageResource(R.drawable.qq_skin_aio_panel_image_press);
                break;
            case FUNC_TYPE_CAMERA:
                btnCamera.setImageResource(R.drawable.qq_skin_aio_panel_camera_press);
                break;
