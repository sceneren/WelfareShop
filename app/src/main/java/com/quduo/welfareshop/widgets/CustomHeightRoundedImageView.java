 ...
 * Author:scene
 * Time:2018/2/2 9:51
 * Description:自定义宽高比和圆角的Imageview
 */
public class CustomHeightRoundedImageView extends android.support.v7.widget.AppCompatImageView {

    public static final String TAG = "自定义的圆角ImageView";
    ...
    public CustomHeightRoundedImageView(Context context) {
        super(context);
    }

    public CustomHeightRoundedImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomHeightRoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.CustomHeightRoundedImageView, defStyle, 0);

        final int index = a.getInt(R.styleable.CustomHeightRoundedImageView_android_scaleType, -1);
        if (index >= 0) {
            setScaleType(sScaleTypeArray[index]);
        }

        mLeftTopCornerRadius = a.getDimensionPixelSize(
                R.styleable.CustomHeightRoundedImageView_custom_sriv_left_top_corner_radius, 0);
        mRightTopCornerRadius = a.getDimensionPixelSize(
                R.styleable.CustomHeightRoundedImageView_custom_sriv_right_top_corner_radius, 0);
        mLeftBottomCornerRadius = a.getDimensionPixelSize(
                R.styleable.CustomHeightRoundedImageView_custom_sriv_left_bottom_corner_radius, 0);
        mRightBottomCornerRadius = a.getDimensionPixelSize(
                R.styleable.CustomHeightRoundedImageView_custom_sriv_right_bottom_corner_radius, 0);
        ...
        mBorderWidth = a.getDimensionPixelSize(
                R.styleable.CustomHeightRoundedImageView_custom_sriv_border_width, 0);
        if (mBorderWidth < 0) {
            throw new IllegalArgumentException("border width cannot be negative.");
        }

        mBorderColor = a
                .getColorStateList(R.styleable.CustomHeightRoundedImageView_custom_sriv_border_color);
        if (mBorderColor == null) {
            mBorderColor = ColorStateList.valueOf(DEFAULT_BORDER_COLOR);
        }

        isOval = a.getBoolean(R.styleable.CustomHeightRoundedImageView_custom_sriv_oval, false);
        mHorizontalWeight = a.getInt(R.styleable.CustomHeightRoundedImageView_custom_horizontal_weight, 1);
        mVerticalWeight = a.getInt(R.styleable.CustomHeightRoundedImageView_custom_vertical_weight, 1);
        mBaseLine = a.getInt(R.styleable.CustomHeightRoundedImageView_custom_base, WIDTH);
        a.recycle();
     ...
     * 设置按比例布局的基准线
     */
    public void setBase(@CustomHeightRoundedImageView.Base int base) {
        mBaseLine = base;
        requestLayout();
    }
    ...
    static class SelectableRoundedCornerDrawable extends Drawable {
        ...
        private static final String TAG = "自定义的CornerDrawable";
        private static final int DEFAULT_BORDER_COLOR = Color.BLACK;
