...
public class ReadView extends View {
    ...
    public ReadView(Context context, String path) {
        ...
        width = PtrLocalDisplay.SCREEN_WIDTH_PIXELS;
        height = PtrLocalDisplay.SCREEN_HEIGHT_PIXELS;
        ...
        try {
            ...
            pagefactory.setBgBitmap(BitmapFactory.decodeResource(context.getResources(), R.drawable.bg_readerview));
